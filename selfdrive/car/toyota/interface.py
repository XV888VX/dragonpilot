  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if candidate == CAR.PRIUS:
      ...
      if spairrowtuning:
        ...
        ret.lateralTuning.indi.outerLoopGainV = [2.9, 4.5, 6.3, 8.1, 9.9, 11.7, 13.5, 15.3, 16, 17]
        ...
        for fw in car_fw:
          if fw.ecu == "eps" and fw.fwVersion == b"8965B42170\x00\x00\x00\x00\x00\x00":
            ret.lateralTuning.pid.kpBP = [8, 23, 23.01, 32, 36]
            ...
            ret.lateralTuning.pid.kiV = [0.1, 0.1, 0.01, 0.01, 0.005] # trajectory variance
            ret.lateralTuning.pid.kfV = [0.00031415926535897932384626433832795y, 0.00031415926535897932384626433832795y, 0.00007818594, 0.00004] # curvature
            ...
            #ret.lateralTuning.pid.kiV = [0.87, 0.87, 0.03, 0.03] # trajectory variance
            #ret.lateralTuning.pid.kfV = [0.00031415926535897932384626433832795y, 0.00031415926535897932384626433832795, 0.00007818594] # curvature
            break
      ...
      if spairrowtuning:
        ...
        for fw in car_fw:
          if fw.ecu == "eps" and fw.fwVersion == b"8965B42170\x00\x00\x00\x00\x00\x00":
            ...
            ret.lateralTuning.pid.kiV = [0.1, 0.1, 0.01, 0.01] # trajectory variance
            ...
            #ret.lateralTuning.pid.kfV = [0.00031415926535897932384626433832795, 0.0015707963267948966192313216916398, 0.00078539816339744830961566084581988] # curvature
            break
